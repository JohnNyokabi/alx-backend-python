...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_public_repos_url(self):
        ...
        with patch.object(GithubOrgClient,
                          ...
                          return_value={"repos_url": "JohnNyokabi"}) as mock_get:
            test_json = {"repos_url": "JohnNyokabi"}
    ...
    @patch("client.get_json", return_value=[{"name": "JohnNyokabi"}])
    def test_public_repos(self, mock_get):
        ...
        with patch.object(GithubOrgClient,
            ...
            self.assertEqual(test_return, ["JohnNyokabi"])
            mock_get.assert_called_once
    ...
    def test_has_license(self, repo, license_key, expected_return):
        ...
        test_client = GithubOrgClient("JohnNyokabi")
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    ...
    def test_public_repos(self):
        ...
        test_class = GithubOrgClient("JohnNyokabi")
        assert True
